...
const images = [
  ...
  'https://images.unsplash.com/photo-1581351123004-757df051db8e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=387&q=80',
];
  ...
  return (
    <div className="app">
      ...
      <div className="overlay">
        <h1 className="title">Welcome to my Modern Home Page!</h1>
